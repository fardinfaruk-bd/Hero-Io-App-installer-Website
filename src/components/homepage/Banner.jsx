...
const Banner = () => {
    return (
        <div className='w-[90%] sm:container mx-auto flex flex-col justify-center items-center gap-10 text-center pt-20'>
            <h1 className='font-bold text-6xl sm:text-7xl text-[#001931]'>We Build <br /> <span className='bg-linear-to-r from-[#9F62F2] to-[#632EE3] bg-clip-text text-transparent'>Productive</span> Apps</h1>
