...
const App = () => {
    ...
    return (
        ...
        <div className='w-[90%] sm:container mx-auto py-15'>
            <div className='space-y-15
             '>
                ...
                {loading ? <HashLoader className='mx-auto' color='#9F62F2' /> : <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5'>
                    {
                        apps.map((app) => {
